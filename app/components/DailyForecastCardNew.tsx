            ...
            >
              ...
              <div className="relative p-5 bg-white/90 backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <p className={`font-bold ${isToday ? 'text-blue-600 text-lg' : 'text-gray-800 text-base'}`}>
                      {dayName}
                    </p>
                ...
                <div className="flex justify-center my-4">
                  <span className="text-6xl drop-shadow-lg" role="img" aria-label={getLabel(day.conditions?.day)}>
                ...
                <div className="flex items-center justify-center space-x-3 mb-4">
                  <div className="text-center">
                    <p className="text-3xl font-bold text-gray-800">{Math.round(day.temperatureMax)}°</p>
                    <p className="text-xs text-gray-500 font-medium">High</p>
                  </div>
                  <div className="h-8 w-px bg-gray-300"></div>
                  <div className="text-center">
                    <p className="text-2xl font-semibold text-gray-600">{Math.round(day.temperatureMin)}°</p>
                ...
                <div className="space-y-2 pt-3 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-2">
                    ...
                    <div className="bg-indigo-50 rounded-lg p-2 text-center">
                      ...
                      <p className="text-xs text-indigo-700 mt-1">{getLabel(day.conditions.night)}</p>
                    </div>
                  </div>
                </div>
