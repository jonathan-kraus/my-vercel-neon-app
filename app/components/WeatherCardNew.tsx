    ...
    <div className={`bg-linear-to-br ${gradientClass} rounded-3xl shadow-2xl p-6 md:p-8 text-white transform transition-all duration-300 hover:scale-[1.02] hover:shadow-3xl relative overflow-hidden`}>
      ...
      <div className="relative flex flex-col space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="text-6xl md:text-7xl transform transition-transform duration-300 hover:scale-110 drop-shadow-2xl" role="img" aria-label={weatherLabel}>
            {weatherIcon}
          </div>
        </div>
        ...
        <div className="flex items-baseline space-x-2">
          <span className="text-6xl md:text-7xl font-bold drop-shadow-lg">{Math.round(weather.temperature)}</span>
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-4 pt-4 border-t border-white/30">
          ...
          <div className={`bg-white/20 backdrop-blur-md rounded-2xl p-4 md:p-5 transition-all duration-300 hover:bg-white/30 hover:scale-105 border border-white/20 ${isWindy ? 'animate-pulse' : ''}`}>
            <div className="flex items-center space-x-2 mb-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {weather.pressure ? (
            ...
            <div className="bg-white/20 backdrop-blur-md rounded-2xl p-4 md:p-5 transition-all duration-300 hover:bg-white/30 hover:scale-105 border border-white/20">
              ...
              <p className="text-2xl md:text-3xl font-bold">{weather.rainAccumulationSum.toFixed(2)}&quot;</p>
            </div>
          ) : (
